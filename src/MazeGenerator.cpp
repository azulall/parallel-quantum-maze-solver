...
// entrance and exit are not generated by this function, they are handled separately in generate_maze function
...
void generate_maze(int n, const char *filename)
{
    ...
    generate_paths(matrix, start.in_x, start.in_y, n);
    ...
    save_maze_to_file(matrix, n, start, end, filename);
...
void print_maze(const char *filename, int n)
{
    ...
    get_maze_from_file(filename, matrix, n);
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        generate_maze(n, filename);
        print_maze(filename, n);
    }
